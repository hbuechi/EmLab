...
usgs_fire_names <- tolower(usgs_fire_names)
cdf_fire_names <- tolower(cdf_fire_names)
...
cdf_fire_diff <- as.data.frame(cdf_fire_diff)
...
calfire_data <- dplyr::rename(calfire_data, FIRE_NAME = Fire_name)
